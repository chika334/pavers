          ...
          <div className="flex-grow-1 w-100 d-flex align-items-center">
            <Container className="">
              <Card
                ...
                className="p-4 card-box card-box-border-bottom my-4"
              >
                <div className="d-block d-md-flex align-items-start">
                  ...
                  <div
                    style={{ color: "#4191ff" }}
                    className="d-flex flex-column pl-md-2 w-100"
                  >
                    <div className="d-block d-md-flex align-items-center justify-content-around">
                      <div className="my-3 my-md-0">
                        ...
                        <div className="font-weight-bold text-dark mt-1 font-size-md">
                          anifowosegbolahan@gmail.com
                        </div>
                      </div>
                      <div className="d-flex nav nav-neutral-first">
                        <Button
                          size="small"
                          className="btn-first mr-4 shadow-none rounded-md line-height-1 font-weight-bold font-size-xs px-3 w-auto py-0 d-40"
                        >
                          Dashboard
                        </Button>
                        <Button
              ...
              <div className="pl-4 d-flex nav-tabs justify-content-center">
                <Button
                  size="small"
                  className="btn-first mr-4 shadow-none rounded-md line-height-1 font-weight-bold font-size-xs px-3 w-auto py-0 d-40"
                >
